...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Age-23-4B5563?style=flat-square" alt="23 years old">
</p>
...
### [.NET concurrency and native interop](https://github.com/guustaaa/acbr-boleto-dotnet)

A .NET 8 layer for concurrent processing over a stateful native library. Its pool uses
exclusive leases and configuration affinity to prevent state leakage between tenants, with
the critical guarantees covered by 113 deterministic tests in CI.

`C#` `.NET 8` `P/Invoke` `Concurrency` `xUnit` `GitHub Actions`
